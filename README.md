...
- **Screen Sharing**: Share your own gameplay with the room, live and peer to peer — the server never sees the picture. Browser screen capture with audio, one sharer at a time, sub-second latency for a handful of viewers
